...
// Actualizar usuario
//===================================================================
usuarioRoutes.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const body = req.body;
    yield usuario.ActualizaUsuario(id, body)
...
//===================================================================
usuarioRoutes.put('/:status/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const stat = req.params.status;
    yield usuario.DesactivarUsuario(id, stat)
        .then((resultado) => {
        return res.status(200).json({
            ok: true,
